...
import be.gling.businessApp.model.adapter.PublicationAdapter;
...
import be.gling.businessApp.model.service.ErrorMessageService;
...
public class WebClient<U extends DTO> {
    ...
    public U sendRequest() throws MyException {//RequestEnum request, DTO dto, Long id, Class<U> expectedResult) throws MyException {
        ...
        gsonBuilder
                .registerTypeAdapter(AbstractPublicationDTO.class, new PublicationAdapter())
                .create();
